...
6.  Find your EC2 url to connect with BlockScout: Go to **EC2 Dashboard -> Instances -> \_corresponding archive node instance**\_ and record the ip address. When configuring BlockScout you will use this address along with port 8545 to connect via the EthereumJsonRPCHttpURL parameter.
